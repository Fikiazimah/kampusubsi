...
<div class="row">
    ...
    <div class="form-group">
        ...
        <select name="prodi" class="form-control">
            ...
            <option value="Teknologi Komputer" {{ old('prodi',$mhs->prodi)=='Teknologi Komputer' ? 'selected' : '' }}>Teknologi Komputer</option>
            <option value="Sistem Informasi Akuntansi" {{ old('prodi',$mhs->prodi)=='Sistem Informasi Akuntansi' ? 'selected' : '' }}>Sistem Informasi Akuntansi</option>
        </select>
    </div>
    <div>
